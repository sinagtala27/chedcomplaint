<template>
  ...
  <script>
  import LineChartComponent from "../admin/LineChart.vue"
  import BarChartComponent from "../admin/BarChart.vue"
  import CategoriesComponent from "../admindb/CategoryDB/Categories.vue"
  import HeaderComponent from "../admin/HeaderAdmin.vue"
  export default {
    name: "dashboard-page",
    components: {
      HeaderComponent,
